...
/////////////////////////////////////
// Plugin class
cr.plugins_.Rex_Tetris = function(runtime)
{
...
(function ()
{
	var pluginProto = cr.plugins_.Rex_Tetris.prototype;
		...
		{	
			...
			if (is_full_line)
			{
                ...
                {                    
		            ...
		            this.runtime.trigger(cr.plugins_.Rex_Tetris.prototype.cnds.OnBricksEliminated, this); 
                    this._clean_cell(x,y);
                }
			}
		} 
        ...
        for(i=0; i<this.FullLineCnt; i++)
        {
            ...
            {    
                ...
                if (cell.mask == 1) 
                {
                    ...
                    // Trigger 'OnBricksEliminated'
		            this.runtime.trigger(cr.plugins_.Rex_Tetris.prototype.cnds.OnBricksFalling, this); 
