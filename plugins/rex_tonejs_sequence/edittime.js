...
//////////////////////////////////////////////////////////////
// Conditions
AddCondition(1, cf_trigger, "On note", "Event", 
            "On note", 
            "Triggered when note event fired.", "OnNoteEvent");
...
AddAction(11, 0, "Remove all", "Notes", 
          "Remove all notes", 
...
AddNumberParam("Index", 'The index of the event to remove.', 0);             
AddExpression(11, ef_return_any | ef_variadic_parameters, 
...
var property_list = [
    new cr.Property(ept_text, "Notes", "", 'Notes separated by ",".'),   
    ...
    new cr.Property(ept_combo, "Start", "No", "Set Yes to start timeline.", "No|Yes"),      
	];
