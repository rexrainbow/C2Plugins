...
(function ()
{
	...
	{
		return board_inst.is_inside_board(lx, ly);
	};	 
	
	instanceProto.IsEmpty = function (board_inst, chess_uid, lx, ly, lz)
	{
		if ( !board_inst.is_inside_board(lx, ly) )
		    return false;
				
	    return board_inst.is_empty(lx, ly, lz);
	};	
