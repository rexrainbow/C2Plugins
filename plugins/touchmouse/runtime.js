...
/////////////////////////////////////
// Plugin class
cr.plugins_.MyTouchMouse = function(runtime)
{
...
(function ()
{
	var pluginProto = cr.plugins_.MyTouchMouse.prototype;
	...
	instanceProto.onMouseDown = function(info)
	{
		...
		// Trigger OnAnyClick
		this.runtime.trigger(cr.plugins_.MyTouchMouse.prototype.cnds.OnAnyClick, this);
		
		// Trigger OnClick & OnObjectClicked
		this.triggerButton = info.which - 1;	// 1-based
		this.triggerType = 0;					// single click
		this.runtime.trigger(cr.plugins_.MyTouchMouse.prototype.cnds.OnClick, this);
		this.runtime.trigger(cr.plugins_.MyTouchMouse.prototype.cnds.OnObjectClicked, this);
	};
