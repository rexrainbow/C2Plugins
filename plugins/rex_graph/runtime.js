...
(function ()
{
	...
	instanceProto.PickVerticesOfEdge = function (edge_type, vertexA_type, vertexB_type)
	{
        ...
        var i, cnt=eInsts.length, eInst, edgeUID, edge, vUID;
        var vAs={}, vBs={};
        for (i=0; i<cnt; i++)
        {
            eInst = eInsts[i];
	...
	{    
        ...
        var i, cnt=vInsts.length, vInst, vUID, vertex, vUID, edgeUID;
        for (i=0; i<cnt; i++)
        {
            vInst = vInsts[i];
    ...
    var DIRSTRMAP = {"->":DIRAtoB,  "<-": DIRBtoA, "<->":(DIRAtoB+DIRBtoA)  };
