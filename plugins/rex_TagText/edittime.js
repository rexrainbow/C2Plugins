function GetPluginSettings()
{
	return {
        ...
        "author":		"Rex.Rainbow",
		"help url":		"http://c2rexplugins.weebly.com/rex_tagtext.html",
		"category":		"Rex - Text",
...
AddStringParam("Name", "Name of tag (class).", "\"\"");
AddCondition(1, cf_not_invertible, "Define tag (class)", "Tag (Class)", "Tag: <i>{0}</i>", "Define tag (<class> ... </class>)", "DefineClass");
