...
/////////////////////////////////////
// Plugin class
cr.plugins_.Rex_NoiseJsMod = function(runtime)
{
...
(function ()
{
	var pluginProto = cr.plugins_.Rex_NoiseJsMod.prototype;
	...
	instanceProto.mapRange = function (val)
	{
        ...
        val = (val + 1)/ 2; // val: 0~1   
        val = this.min + (this.max - this.min)*val;
        return val;
	};  
	...
	Acts.prototype.SetRangeOfOutput = function (min, max)
	{
        this.min = min;
        this.max = max;
	};    
...
// ---- perlin.js ----
    ...
    // 2D simplex noise
    NoiseProto.simplex2 = function(xin, yin) 
    {
    ...
    // 3D simplex noise
    NoiseProto.simplex3 = function(xin, yin, zin) 
    {
    ...
    // 2D Perlin Noise
    NoiseProto.perlin2 = function(x, y) 
    {
    ...
    // 3D Perlin Noise
    NoiseProto.perlin3 = function(x, y, z) 
    {
        // Find unit grid cell containing point
