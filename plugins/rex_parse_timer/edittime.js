function GetPluginSettings()
{
	return {
		...
		"author":		"Rex.Rainbow",
		"help url":		"http://c2rexplugins.weebly.com/rex_parse_timer.html",
...
AddAction(1, 0, "Start", "Timer", 
          "Start userID: <i>{0}</i> 's timer <i>{1}</i>, with time-out interval to <i>{2}</i>", 
...
var property_list = [
    ...
    new cr.Property(ept_combo, "Cache", "Yes", "Cache objectID of timer.", "No|Yes"),     
	];
