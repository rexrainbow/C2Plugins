...
var u
for(o in i.params)if(s=i.params[o],u=t&&"undefined"!=typeof t[o]?t[o]:null,!u&&s.extract_from&&s.extract_from.alias&&(u=t[s.extract_from.alias]),u){if(s.extract_from&&u.constructor===Newgrounds.io.model[s.extract_from.object]&&(u=u[s.extract_from.property]),!Newgrounds.io.model.checkStrictValue(null,o,u,s.type,null,null,null))throw new Error("Illegal value for '"+o+"' parameter of '"+e+"': "+u)}else if(s.required)throw new Error("Missing required parameter for '"+e+"': "+o)},_validateCall:function(e){var t
