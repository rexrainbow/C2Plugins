...
var property_list = [
    ...
    //new cr.Property(ept_combo, "Oscillator type", "Triangle", "The type of the oscillator.", "Sine|Square|Triangle|Custom|Pwm|Pulse"),
	...
	//new cr.Property(ept_float, "Sustain", 0.3, "The sustain value is the value which the envelope rests at after triggerAttack is called, but before triggerRelease is invoked."),
