...
/////////////////////////////////////
// Behavior class
cr.behaviors.Rex_bFunction2 = function(runtime)
{
...
(function ()
{
	var behaviorProto = cr.behaviors.Rex_bFunction2.prototype;
    ...
    behinstProto.function_call_prelude = function()
    {
        this.param_index = 0;
    };
    
    behinstProto.function_call_finale = function()
    {
    ...
    behinstProto.define_param = function (name, default_value, type_check)
    {
        var fs = this.funcStack.getCurrentEntry();
    ...
    Acts.prototype.CallFunctionwPT = function (name_, tale_)
    {
        ...
        this.function_call_prelude();
        // Note: executing fast trigger path based on fs.name
        var ran = this.runtime.trigger(cr.behaviors.Rex_bFunction2.prototype.cnds.OnFunction, this.inst, fs.name);
        this.function_call_finale();
