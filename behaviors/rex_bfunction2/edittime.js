function GetBehaviorSettings()
{
	return {
		...
		"author":		"Rex.Rainbow",
		"help url":		"https://rexrainbow.github.io/C2RexDoc/c2rexpluginsACE/behavior_rex_bfunction2.html",
...
AddCondition(0,	cf_trigger | cf_fast_trigger, "On function", "Function", "{my} <b>{0}</b>", "Triggered when a function is called.", "OnFunction");
...
AddCondition(1, cf_none, "Compare parameter", "Parameter", "{my} parameter {0} {1} {2}", "Compare the value of a parameter in a function call.", "CompareParam");

AddAnyTypeParam("Index", "The zero-based index of the parameter to get, or name in string.");
AddComboParamOption("Number");
AddComboParamOption("String");
AddComboParam("Type", "The type of value.", 0);
AddCondition(51, cf_none, "Type of parameter", "Parameter", "{my} parameter {0} is a {1}", "Test the type of parameter.", "TypeOfParam");
...
//AddAction(0, 0, "Call function", "Parameter list", "{my} call <b>{0}</b> (<i>{...}</i>)", "Call a function, running its 'On function' event.", "CallFunction");

AddAnyTypeParam("Value", "A number or some text to return from the function call.");
AddAction(1, 0, "Set return value", "Return", "{my} set return value to <b>{0}</b>", "In an 'On function' event, set the return value.", "SetReturnValue");

AddAnyTypeParam("Expression", "An expression to run, generally of the form Function.Call(\"func\", ...)");
AddAction(2, 0, "Call expression", "Function", "{my} call expression <b>{0}</b>", "Call a function using a typed expression (via Function.Call()).", "CallExpression");
...
AddAction(51, 0, "Declare parameter", "Interface", "{my} parameter <b>{0}</b>, default to <i>{1}</i> <i>{2}</i>", "Declare input parameter in name string and it's default value", "DefineParam");

AddAction(52, 0, "Dump", "Log", "{my} dump function infomation", "Dump function infomation in console, it need turn on debug mode.","Dump");

AddAnyTypeParam("Name", "Name of parameter", '""');
AddAnyTypeParam("Value", "Value", "0");
AddStringParam("Table", "Name of parameter table.", '"_"');
AddAction(53, 0, "Set parameter", "Parameter table", "{my} set parameter <b>{0}</b> to <b>{1}</b> at table <i>{2}</i>", "Set a parameter table.", "SetParameter");

AddStringParam("Name", "The name of the function to call.", "\"\"");
AddStringParam("Table", "Name of parameter table.", '"_"');
AddAction(54, 0, "Call function", "Parameter table", "{my} call <b>{0}</b> with parameter table <i>{1}</i>", "Call a function, running its 'On function' event with parameter table.", "CallFunctionwPT");
