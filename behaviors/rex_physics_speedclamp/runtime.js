...
/////////////////////////////////////
// Behavior class
cr.behaviors.Rex_physics_speedclamp = function(runtime)
{
...
(function ()
{
	var behaviorProto = cr.behaviors.Rex_physics_speedclamp.prototype;
	...
	behinstProto.tick = function ()
	{
        ...
        else
        {
            ...
            if (speed < this.lower_bound)
            {
                ...
                this.runtime.trigger(cr.behaviors.Rex_physics_speedclamp.prototype.cnds.OnHitLowerBound, this.inst);
            }
            else if (speed > this.upper_bound)
            {
                this.set_speed(this.upper_bound);
                this.runtime.trigger(cr.behaviors.Rex_physics_speedclamp.prototype.cnds.OnHitUpperBound, this.inst);
            }
        }
	};	
    ...
    behinstProto._get_velocity_x = function ()
	{     
        var physics_behavior_inst = this._get_physics_behavior_inst();
        cr.behaviors.Physics.prototype.exps.VelocityX.call(physics_behavior_inst, fake_ret);
        return fake_ret.value;   
	};
    behinstProto._get_velocity_y = function ()
	{     
        var physics_behavior_inst = this._get_physics_behavior_inst();    
        cr.behaviors.Physics.prototype.exps.VelocityY.call(physics_behavior_inst, fake_ret);
        return fake_ret.value;   
	};
    
    behinstProto.get_speed = function ()
	{     
        var vx=this._get_velocity_x(), vy=this._get_velocity_y();
	...
	{     
        ...
        var new_vx = speed * Math.cos(a);
        var new_vy = speed * Math.sin(a);
        if ((new_vx !== vx) || (new_vy !== vy)) 
        {
            var physics_behavior_inst = this._get_physics_behavior_inst(); 
            cr.behaviors.Physics.prototype.acts.SetVelocity.call(physics_behavior_inst, new_vx, new_vy);
        }
	};
