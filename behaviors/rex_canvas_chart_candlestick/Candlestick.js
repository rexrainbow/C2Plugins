 ...
 */
window.Candlestick = function(context, rawData, options){
  // utility finctions
  ...
  // end of add format to string, test with: "{0} is dead, but {1} is alive! {0} {2}".format("ASP", "ASP.NET")
	...
	// ---- edit by rex.rainbow ---- 
	// get context from 1st input parameter
  ...
  function getColor(j){
    var colors = options.upperindicatorslinecolors? 
                     options.upperindicatorslinecolors:
                     ['coral','crimson','darkblue','chocolate','chartreuse','blueviolet','darksalmon'];
