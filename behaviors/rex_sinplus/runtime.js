...
/////////////////////////////////////
// Behavior class
cr.behaviors.Rex_SinPlus = function(runtime)
{
...
(function ()
{
	var behaviorProto = cr.behaviors.Rex_SinPlus.prototype;
	...
	behinstProto.onCreate = function()
	{
        ...
        this.sin_obj = new cr.behaviors.Rex_SinPlus.SineKlass(this.inst, movement, 
	...
	behinstProto.tick = function ()
	{
        if (this.active)
        {
            ...
            if (this.is_over)
            {
                this.runtime.trigger(cr.behaviors.Rex_SinPlus.prototype.cnds.OnOver, inst);            
            }
...
(function ()
{
    ...
    cr.behaviors.Rex_SinPlus.SineKlass = function(inst, movement, 
                                                    period, period_offset,
                                                    magnitude)
    {
		if (period === 0)
        ...
        this.i_init = period_offset;
    };
    var SineKlassProto = cr.behaviors.Rex_SinPlus.SineKlass.prototype;
