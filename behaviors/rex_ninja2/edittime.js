function GetBehaviorSettings()
{
	return {
		...
		"author":		"Rex.Rainbow",
		"help url":		"http://c2rexplugins.weebly.com/rex_ninja2.html",
		"category":		"Rex - Touch",
		"flags":		bf_onlyone
	};
};
...
AddAction(0, 0, "Set activated", "", "Set {my} activated to <i>{0}</i>", "Enable the object's ninja behavior.", "SetActivated");
